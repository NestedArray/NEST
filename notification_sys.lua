...
return function(Arguments)
	task_spawn(coroutine_create(function()
		...
		local ScreenGui = CoreGui:FindFirstChild("Error") or Instance_new("ScreenGui", CoreGui)
		...
		local UIGradience = Instance.new("UIGradient")
		UIGradience.Parent = ErrorMessage
		UIGradience.Rotation = 0
		
		UIGradience.Transparency = NumberSequence.new({
			NumberSequenceKeypoint.new(0, 0),
			NumberSequenceKeypoint.new(0.6, 0),
			NumberSequenceKeypoint.new(1, 1)
		})
		
		UIGradience.Color = ColorSequence.new({
		...
		if not ScreenGui.Parent == CoreGui then
		...
		ErrorMessage.BackgroundColor3 = Color3_fromRGB(255, 255, 255)
		ErrorMessage.BackgroundTransparency = 0.55
